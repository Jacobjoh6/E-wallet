...
import { deleteCard, activeCard } from '../../action';
...
function Card(props) {
    ...
    function displayActive() {
        dispatch(activeCard(props.fullCard))
    }

    function removeCard() {
        dispatch(deleteCard(props.fullCard))
    }
    ...
    return(
        <section className={`card-comp ${props.fullCard.vendor}`} onClick={ displayActive }>  
            ...
            <h1 className='card-comp__numbers'>{props.fullCard.cardnr}</h1>
            ...
            <article className='card-comp__info'>
                <h2 className='card-comp__label__h2'>{props.fullCard.name}</h2>
                <h2 className='card-comp__label__h2'>{props.fullCard.date}</h2>
            </article>
